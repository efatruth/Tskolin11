...
# This time around we are going to check if the mouse is inside a rectangle
# that has been placed in the game window.  To do that we make use of a nice little
